...
| 异常场景                       | 自动处理方案                                                                                                                              |
| ------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------- |
| 访问令牌过期（错误码99991663） | 运行 `cd "$SKILL_DIR/scripts" && node get-tenant-access-token.js --parameter-file-path <参数文件绝对路径>` 刷新令牌，更新参数文件后重试   |
...
- ✅ **正确做法**：`cd "$SKILL_DIR/scripts" && node markdown-to-feishu.js --parameter-file-path <参数文件绝对路径>`
...
```bash
cd "$SKILL_DIR/scripts" && node markdown-to-feishu.js --parameter-file-path <参数文件绝对路径>
```
