...
| 操作 | records 格式 | 示例 |
| --- | --- | --- |
| **批量创建** | 对象数组，包含 fields | `[{"fields": {...}}]` |
| **批量更新** | 对象数组，包含 record_id 和 fields | `[{"record_id": "xxx", "fields": {...}}]` |
| **批量删除** | **字符串数组**，仅 record_id | `["recxxx", "recyyy"]` |
| **批量获取** | **字符串数组**，仅 record_id | `["recxxx", "recyyy"]` |
...
2. **运行脚本**
   ...
   ```bash
   node scripts/record/batch-delete.js --parameter-file-path "C:/Users/username/AppData/Local/Temp/feishu-operation-1740374400000-a7x9k2.json"
   ```
