...
```json
{
  ...
  "extra": {
    ...
    "examples": [
      "{\"drive_route_token\":\"D7rGbT0YGaJzKRsg3eUcCyzSnlf\"}"
    ]
  },
  "file_path": {
    "required": true,
...
| `Cannot read properties of undefined` | 参数名拼写错误               | 检查参数名是否为 `file_tokens`（复数）   |
...
1. **运行脚本**
   ...
   ```bash
   node scripts/media/upload.js --parameter-file-path "C:/Users/username/AppData/Local/Temp/feishu-operation-1740374400000-a7x9k2.json"
   ```
