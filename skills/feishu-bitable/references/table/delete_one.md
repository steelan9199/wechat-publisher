# 飞书多维表格`删除一个数据表`API使用指南

## 📋 概述

**API功能**：通过 app_token 和 table_id 删除指定的多维表格数据表
**频率限制**：10 次/秒
...
2. **运行脚本**
   ...
   ```bash
   node scripts/table/delete-one.js --parameter-file-path "C:/Users/username/AppData/Local/Temp/feishu-operation-1740374400000-a7x9k2.json"
   ```
