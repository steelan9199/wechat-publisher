---
name: elite-intent-architect-yashu
description: "仅当用户请求的文本末尾显式包含以下4个确切关键词之一时才触发此技能：『反向提问』、『理清需求』、『顾问模式』、『专家对齐』。触发本技能后，AI 将化身为顶级领域专家，通过洞察潜台词、做出专家假设，并使用『动态渐进式提问』以极低认知摩擦帮助用户理清需求，达成对齐后再执行核心任务。"
---
