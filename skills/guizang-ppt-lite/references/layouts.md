...
<section class="slide hero dark">
  ...
  <div
    class="frame"
    style="display:grid; gap:4vh; align-content:center; min-height:80vh"
  >
    ...
    <p class="lead" style="max-width:60vw" data-anim>
      一个 AI 创作者 —— 在 64 天里做了 11 万行代码、在 9
      个平台上持续输出，生活节奏几乎没有被改变。
    </p>
    <div class="meta-row" data-anim>
      <span>歸藏 Guizang</span><span>·</span
...
<section class="slide hero light">
  ...
  <div
    class="frame"
    style="display:grid; gap:6vh; align-content:center; min-height:80vh"
  >
    <div class="kicker" data-anim>Act I</div>
    <h1 class="h-hero" style="font-size:8.5vw" data-anim>硬数据</h1>
    <p class="lead" style="max-width:55vw" data-anim>先看数字，再谈方法。</p>
  </div>
  <div class="foot">
    <div>第一幕引子</div>
    <div>— · —</div>
...
<section class="slide light">
  ...
  <div class="frame" style="padding-top:6vh">
    ...
    <p class="lead" style="margin-bottom:5vh" data-anim>
      从 0 到开源 CodePilot。
    </p>
...
- **垂直空间预算**：`.frame` 容器有 `overflow:hidden`，内容总高度（标题 + lead + grid 卡牌 + stat-note 文字）必须能全部容纳在 frame 内。生成后若发现底部 stat-note 文字被裁切，按以下优先级修复：
  1. 缩小 `.grid-4` / `.grid-6` 的 gap（内联 `style="gap:2.2vh 6vw"`）
  2. 降低 `stat-nb` 字号（内联 `style="font-size:3.2vw"`）
  3. 减小 `stat-note` 字号和行高（`font-size:max(11px,.85vw);line-height:1.45`）
  4. 收紧标题区间距（kicker margin-bottom、lead margin-bottom）
  5. 缩小 `.frame` 的 `padding-top`
     **不要**用 `overflow:visible` 绕过裁切——文字会溢出到 frame 边界外。
...
<section class="slide light">
  ...
  <div class="frame grid-2-7-5" style="padding-top:6vh">
    ...
    <div
      style="display:flex; flex-direction:column; justify-content:space-between; gap:3vh"
    >
      <div>
    ...
    <div class="pipeline-section">
      ...
      <div class="pipeline">
        ...
        <div class="step" data-anim="step">
          ...
          <div class="step-desc">整理成信息图</div>
        </div>
        <div class="step" data-anim="step">
...
<section class="slide hero dark">
  ...
  <div
    class="frame"
    style="display:grid; gap:8vh; align-content:center; min-height:80vh"
  >
...
<section class="slide light" data-animate="quote">
  ...
  <div
    class="frame"
    style="display:grid; gap:5vh; align-content:center; min-height:80vh"
  >
...
<section class="slide light" data-animate="directional">
  ...
  <div class="frame" style="padding-top:5vh">
    ...
    <div class="grid-2-6-6" style="gap:5vw 4vh">
      ...
      <div
        data-anim="left"
        style="padding:3vh 2vw; border-left:3px solid currentColor; opacity:.55"
      >
      ...
      <div
        data-anim="right"
        style="padding:3vh 2vw; border-left:3px solid currentColor"
      >
...
<section class="slide light">
  ...
  <div class="frame grid-2-8-4" style="padding-top:6vh">
    ...
    <div>
      ...
      <h2 class="h-xl" style="margin-top:1vh; margin-bottom:3vh" data-anim>
        设计先行 · 2 周
      </h2>
