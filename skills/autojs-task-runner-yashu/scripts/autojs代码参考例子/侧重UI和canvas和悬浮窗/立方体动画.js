...
function rotate(p1, p2, d) {
  ...
  var ix = 0,
    ...
    iz = 0;
  iy =
    y * Math.cos((d.x * Math.PI) / 180) - z * Math.sin((d.x * Math.PI) / 180);
  z = y * Math.sin((d.x * Math.PI) / 180) + z * Math.cos((d.x * Math.PI) / 180);
  y = iy;
  ix =
    x * Math.cos((d.z * Math.PI) / 180) - y * Math.sin((d.z * Math.PI) / 180);
  y = x * Math.sin((d.z * Math.PI) / 180) + y * Math.cos((d.z * Math.PI) / 180);
  x = ix;
  ix =
    x * Math.cos((d.y * Math.PI) / 180) - z * Math.sin((d.y * Math.PI) / 180);
