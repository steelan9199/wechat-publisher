#!/usr/bin/env node
// zip-lib.js - 用 zip-stream 把工程打包成标准 ZIP（deflate 压缩）
//
// 用途：deploy-project.js 的 --zip 模式把多个文件打成一个 .zip，
...
//   node zip-lib.js a.js b.js c.png
if (process.argv[1] && process.argv[1].replace(/\\/g, "/").endsWith("zip-lib.js")) {
