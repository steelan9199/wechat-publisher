 ...
 *   zipPath   {string} 必填  zip 在手机上的绝对路径（如 脚本根目录(动态拼接)/demo.zip）
...
try {
  ...
  var targetDir = typeof args.targetDir === "string" && args.targetDir ? args.targetDir : files.join(files.getSdcardPath(), "脚本");
